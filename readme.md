...
Requires Maven to build and run.
Testing suite and manual execution are separated for clarity.
Launch instructions differ slightly depending on whether you want to manually interact or test.